...
- [ ] 2.3 Registrar `traefik-quay` en el catálogo para `deployment-project-list`.
...
- [ ] 3.5 Integrar autenticación de Quay con Keycloak (OIDC/SSO) según contrato del proyecto.
...
- [ ] 4.3 Documentar ejecución de `project=traefik-quay` y override TLS.
