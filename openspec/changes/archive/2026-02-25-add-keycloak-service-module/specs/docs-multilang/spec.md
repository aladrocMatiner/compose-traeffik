...
#### Scenario: Keycloak service docs added
- **WHEN** the Keycloak service module is documented
- **THEN** `services/keycloak/README.md`, `services/keycloak/README.es.md`, and `services/keycloak/README.sv.md` exist with a language selector
