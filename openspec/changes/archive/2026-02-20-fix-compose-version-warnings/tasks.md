- [x] Title: Identify compose files with deprecated version key
  Files: `compose/base.yml`, `services/*/compose.yml`
  Acceptance: All files containing `version:` are listed.

- [x] Title: Remove version key from compose fragments
