...
- [ ] 1.1 Confirmar `traefik-wikijs` como proyecto soportado en el catálogo.
...
- [ ] 1.4 Validar artefactos del cambio con `openspec validate add-project-traefik-wikijs --strict`.

## 2. Project Definition

- [ ] 2.1 Crear estructura `deployment/projects/traefik-wikijs/`.
...
- [ ] 2.3 Registrar `traefik-wikijs` en el catálogo para `deployment-project-list`.

## 3. Deployment Behavior

- [ ] 3.1 Implementar tasks Ansible para sync de `compose-traeffik` en la VM objetivo.
- [ ] 3.2 Ejecutar compose para los servicios del proyecto Wiki.js definidos en manifiesto.
...
- [ ] 3.5 Integrar configuración de autenticación de Wiki.js contra Keycloak según contrato del proyecto.
- [ ] 3.6 Garantizar idempotencia razonable del flujo.
- [ ] 3.7 Asegurar que Wiki.js se publica detrás de Traefik y que la terminación TLS la gestiona Traefik según `tls_mode`.
...
- [ ] 4.3 Documentar ejecución de `project=traefik-wikijs` y override TLS.
...
- [ ] 5.1 Re-ejecutar `openspec validate add-project-traefik-wikijs --strict`.
