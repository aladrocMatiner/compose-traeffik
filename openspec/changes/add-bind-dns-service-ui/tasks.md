...
- [ ] Title: Crear compose del servicio bind y UI web
...
- [ ] Title: Añadir router y BasicAuth para bind UI
...
- [ ] Title: Definir variables de bind en .env y generar credenciales
...
- [ ] Title: Validar profile bind y bloquear bind+dns simultaneo
...
- [ ] Title: Crear README del servicio bind y registrar en manifest
