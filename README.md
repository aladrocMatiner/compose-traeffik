...
- **Rocket.Chat**: `https://rocketchat.${DEV_DOMAIN}` (profile `rocketchat`; routed by Traefik; optional Keycloak/observability hooks)
...
- [Rocket.Chat](services/rocketchat/README.md) - optional chat application module behind Traefik.
...
Rocket.Chat static smoke suite: `make test-rocketchat`.
