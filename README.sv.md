...
- **Prometheus/Loki**: interna som standard (profil `observability`; ingen publik endpoint)
...
- [Observability](services/observability/README.sv.md) - valfri profil `observability` (Grafana/Prometheus/Loki/Alloy).
